...
export const DumbbellIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M10.022 21.622L4.378 16a2.25 2.25 0 010-3.182l5.644-5.644a2.25 2.25 0 013.182 0l5.644 5.644a2.25 2.25 0 010 3.182l-5.644 5.644a2.25 2.25 0 01-3.182 0z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12.75 9.75l-1.5 1.5-1.5-1.5-1.5 1.5-1.5-1.5M17.25 14.25l-1.5 1.5-1.5-1.5-1.5 1.5-1.5-1.5" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 2.25v-.75a3.375 3.375 0 013.375-3.375h.001c1.86 0 3.375 1.516 3.375 3.375v.75m-6.75 19.5v.75a3.375 3.375 0 003.375 3.375h.001c1.86 0 3.375-1.515 3.375-3.375v-.75" />
</svg>
